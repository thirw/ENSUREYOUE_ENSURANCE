...
import com.mfu.proccess.exceptions.NonexistentEntityException;
import com.mfu.proccess.exceptions.PreexistingEntityException;
import com.mfu.proccess.exceptions.RollbackFailureException;
...
public class ContactJpaController implements Serializable {
    ...
    public ContactJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Contact contact) throws PreexistingEntityException, RollbackFailureException, Exception {
    ...
    public void edit(Contact contact) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
