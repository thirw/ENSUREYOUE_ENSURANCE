...
<html>
    ...
    <body>
        <div class="mdl-layout__container" >
            ...
            <%
                String resultEn15 = request.getParameter("resultEn15");
                String resultEn20 = request.getParameter("resultEn20");
                        ...
                        <div class="mdl-cell mdl-cell--4-col">
                            <div class="demo-card-square mdl-card mdl-shadow--2dp">
                                ...
                                <div class="mdl-card__actions mdl-card--border  mdl-typography--text-center">
                                    <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="Detail.jsp?resultEn15=<%=resultEn15%>&resultEn20=<%=resultEn20%>&resultChip=<%=resultChip%>">                                        
                                        รายละเอียด
                                    </a>
