                                ...
                                <div>
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                <th>จ่ายเบี้ยปีละ</th>
                                                <th><%=request.getParameter("resultChip")%> บาท</th>
                                            </tr>
                                            </tr>
                                            <tr>
                                                <th>High Saving 18/6</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>รับเงืนคืน 1% ของทุนประกันภัยเริ้มต้นทุกปี ปีละ</td>
                                                <td><%=request.getParameter("resultSaving6A")%> บาท</td>
                                            </tr>
                                            <tr>
                                                <td>รับเงินคืน ตั้งแต่สิ้นปี กรมธรณ์ที่ 1-17 รวมรับเงินคืน </td>
                                                <td><%=request.getParameter("resultSaving6B")%> บาท</td>
                                            </tr>
                                            <tr>
                                                <td>ครบสัญญารับเงืนคืน 118% ของทุนประกันภัย</td>
                                                <td><%=request.getParameter("resultSaving6C")%> บาท</td>
                                            </tr>
                                            <tr>
                                                <td>เงืนคืนสิ้นกรมธรณ์</td>
                                                <td><%=request.getParameter("resultSaving6D")%> บาท</td>
                                            </tr>  
                                            <tr>
                                                <td></td>
                                                <td></td>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>ครบสัญญารับเงินคืน 140% ของทุนประกันภัย</td>
                                                <td><%=request.getParameter("resultSaving12A")%> บาท</td>
                                            </tr>                                               
                                        </tbody>
                                    </table>                 
                                </div>          
